        ...
        <div className="flex w-full px-60 bg-[#191C1F]">
            ...
            <div className="flex flex-col flex w-1/2 items-end justify-center">
                <div className="flex flex-col gap-20">
                    <div className="flex flex-col font-semibold gap-5 w-[50rem] text-7xl max-6xl:text-[4.2rem] max-6xl:w-[39.5rem] max-5xl:text-5xl max-5xl:w-[32rem] max-4xl:text-5xl max-4xl:w-[28rem] max-3xl:text-[2.8rem] max-3xl:w-[26rem]">
