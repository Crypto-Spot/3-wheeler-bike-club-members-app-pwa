...
import { memberBadgeSchemaID } from "@/utils/constants/addresses"
import { DataLocationOnChain } from "@ethsign/sp-sdk"

export function deconstructMemberBadgeAttestationData(recipients: string[], country: string, driverID: string ) {
    const schemaData = {
        country: country,
        driverID: driverID,
    }
